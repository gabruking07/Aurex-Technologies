      ...
      <div className="container">
        ...
        {portfolio.length > 0 ? (
          <div className="mt-12 grid gap-5 lg:grid-cols-3">
            ...
            >
              <div className="aspect-[4/3] rounded-md border bg-[linear-gradient(135deg,hsl(var(--primary)/0.95),hsl(var(--accent)/0.75)_55%,hsl(var(--secondary)))] p-4 text-primary-foreground">
